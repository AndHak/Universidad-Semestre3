import sys
from PySide6.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QDial, QLabel, QWidget, QHBoxLayout
...
class EqualizerBand(QWidget):
    ...
    def initUI(self, label):
        ...
        self.dial.valueChanged.connect(self.updateValueLabel)
