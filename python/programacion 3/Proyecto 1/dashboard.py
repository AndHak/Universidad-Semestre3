...
class MainApp(QMainWindow, Ui_MainWindow):
    ...
    def cargar_foto_de_perfil(self):
        ...
        if file_name:
            nueva_foto = QPixmap(file_name).scaled(QSize(self.label_myprofile_page_photo_2.width(), self.label_myprofile_page_photo_2.height()), Qt.KeepAsppectRatioByExpanding, Qt.SmootgTransformation)
